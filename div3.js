...
function RadarChart() {
	...
	var svg = d3.select("#div3")
			.append("svg")
			.attr("id", "radarChart")
			.attr("width",  cfg.w + cfg.margin3.left + cfg.margin3.right)
			.attr("height", cfg.h + cfg.margin3.top + cfg.margin3.bottom)
	//Append a g element		
	var g = svg.append("g")
			.attr("transform", "translate(" + (cfg.w/2 + cfg.margin3.left) + "," + (cfg.h/2 + cfg.margin3.top) + ")");
